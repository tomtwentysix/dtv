      ...
      <div className="pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Dialog open={showFeedbackModal} onOpenChange={setShowFeedbackModal}>
            <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden transition-all duration-500 ease-in-out" style={{ minHeight: 'auto' }}>
              <DialogHeader>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full transition-all duration-500 ease-in-out">
                ...
                {/* Feedback Tab */}
                <TabsContent value="feedback" className="overflow-hidden transition-all duration-500 ease-in-out animate-in fade-in-0 slide-in-from-bottom-2" style={{ minHeight: '60vh' }}>
                ...
                {/* Edit Tab */}
                <TabsContent value="edit" className="overflow-y-auto transition-all duration-500 ease-in-out animate-in fade-in-0 slide-in-from-bottom-2" style={{ minHeight: '40vh' }}>
                  <div className="space-y-4">
                ...
                {/* Assign Tab */}
                <TabsContent value="assign" className="overflow-y-auto transition-all duration-500 ease-in-out animate-in fade-in-0 slide-in-from-bottom-2" style={{ minHeight: '30vh' }}>
                  <div className="space-y-4">
                    <h3 className="font-semibold flex items-center gap-2">
                ...
                {/* Settings Tab */}
                <TabsContent value="settings" className="overflow-y-auto transition-all duration-500 ease-in-out animate-in fade-in-0 slide-in-from-bottom-2" style={{ minHeight: '50vh' }}>
